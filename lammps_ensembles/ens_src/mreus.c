...
void mreus(void *lmp, MPI_Comm subcomm, int ncomms, int comm,  
           char *EVBfix, char *fix, char *ThermoFix,
           int seed, int coordtype, int nsteps_short, int dump, int dump_swap, int group_swap, 
        ...
        // ************ TEMPER dimension ************* //
          ...
          if (partner_proc != -1) {
            ...
            if (swap) {
              ...
              lammps_mod_inst(lmp, 1, ThermoFix, "reset_target", &world2temperature[partner_comm]);
