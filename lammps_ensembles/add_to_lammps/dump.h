...
class Dump : protected Pointers {
 public:
  ...
  // AWGL: stuff for parallel tempering
  char *filename;            // promoted, user-specified file
  void closefile();          // closes the dump file and sets append flag
  virtual void openfile();   // promoted, open function

 protected:
  int me,nprocs;             // proc info

  // AWGL: promoted to public so that I can modify it 
